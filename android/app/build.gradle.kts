...
// Load optional signing config from keystore.properties (kept out of VCS).
val keystorePropsFile = rootProject.file("keystore.properties")
val keystoreProps = Properties().apply {
    if (keystorePropsFile.exists()) load(FileInputStream(keystorePropsFile))
}

// Default backend endpoint. Override at build time with -PomertaBackendUrl=... ,
...
android {
    ...
    buildTypes {
        ...
        release {
            ...
            // Use the release keystore when configured, otherwise fall back to
            // the debug key so `assembleRelease` always produces an installable APK.
